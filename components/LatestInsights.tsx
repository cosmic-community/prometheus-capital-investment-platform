      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {displayInsights.map((insight) => (
            ...
            >
              <article className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 transition-all duration-200 group-hover:shadow-md group-hover:border-primary-200">
